...
const OidcUserLink = require('./oidcUserLink')(sequelize);
...
// OidcUserLink associations
User.hasMany(OidcUserLink, { foreignKey: 'user_id' });
OidcUserLink.belongsTo(User, { foreignKey: 'user_id' });
